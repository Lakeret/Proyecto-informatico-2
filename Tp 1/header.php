...
<div class="cart-drawer" id="cartDrawer">
    <div class="cart-drawer-header">
        <div class="cart-drawer-title-row d-flex justify-content-between align-items-center">
                    ...
                    <div class="cart-drawer-info flex-grow-1">
                        ...
                        <div class="cart-item-bottom d-flex flex-wrap align-items-center gap-3">
                            <form method="post" action="cart_action.php" class="cart-qty-form d-flex align-items-center gap-2">
                                ...
                                <input type="hidden" name="redirect" value="<?= htmlspecialchars($currentUrl . '#cart') ?>">
                            ...
                            <form method="post" action="cart_action.php" class="cart-remove-form ms-auto">
    ...
    <div class="cart-drawer-footer">
        <div class="cart-drawer-summary-row">
            <div class="cart-drawer-summary-info">
                <div class="cart-drawer-summary-line">
                    <span>Subtotal</span>
            ...
            <div class="cart-drawer-summary-action">
                <form method="post" action="cart_action.php" class="h-100">
